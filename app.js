...
var nftExplorerRouter = require('./routes/nft-explorer');
...
var corsProxyRouter = require('./routes/cors_proxy');
...
app.use('/nft-explorer' , nftExplorerRouter);
